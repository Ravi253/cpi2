...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
     ...
     //*[local-name() = 'Timestamp' ]/text())">
                     ...
                     <Body>
                           <xsl:element name="IRenvelope" xmlns="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2">
                                  <IRheader xmlns="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2">
                                         <xsl:if test="boolean(//*[local-name() = 'TestMessage' and namespace-uri() =  'http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2']/text())">
                                                <TestMessage>
                                                       <xsl:value-of select="//*[local-name() = 'TestMessage' and namespace-uri() =  'http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2']"/>
                                                </TestMessage>
                                         </xsl:if>
                                         <Keys>
	                                         <Key Type="TaxOfficeNumber">
                                 ...
                                 <FullPaymentSubmission xmlns="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2">
       ...
       <xsl:template match="//*[local-name() = 'CompressedPart']">
              <xsl:element name="CompressedPart" namespace="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2">
       ...
       <xsl:template match="//*[local-name() = 'Key' and namespace-uri() =  'http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2' and position() = 1]">
              <xsl:element name="Key" namespace="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2">
                     <xsl:attribute name="Type">
                           <xsl:value-of select=".//@Type"/>
                     </xsl:attribute>
                     <xsl:value-of select="//*[local-name() = 'Key' and namespace-uri() =  'http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2' and position() = 1]"/>
              </xsl:element>
       </xsl:template>
       <xsl:template match="//*[local-name() = 'Key' and namespace-uri() =  'http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2' and position() = 2]">
              <xsl:element name="Key" namespace="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2">
                     <xsl:attribute name="Type">
                           <xsl:value-of select=".//@Type"/>
                     </xsl:attribute>
                     <xsl:value-of select="//*[local-name() = 'Key' and namespace-uri() =  'http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2' and position() = 2]"/>
              </xsl:element>
       </xsl:template>
	   ...
	   <xsl:template match="//*[local-name() = 'FinalSubmission']">
		  <xsl:if test="boolean(//*[local-name() = 'ForYear']/text())">
            <FinalSubmission xmlns="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2">
				<xsl:if test="boolean(//*[local-name() = 'ForYear']/text())">
				   <ForYear>
       ...
       <xsl:template match="//*[local-name() = 'EmpRefs']">
              <EmpRefs xmlns="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/23-24/2">
                     <OfficeNo>
